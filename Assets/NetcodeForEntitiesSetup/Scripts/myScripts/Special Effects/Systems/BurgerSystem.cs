...
[BurstCompile]
public partial struct BurgerDropSystem : ISystem
{
    [BurstCompile]
    ...
    [BurstCompile]
    public partial struct BurgerDropJob : IJobEntity
    {
        public float DeltaTime;
        public float3 Gravity;
        public EntityCommandBuffer.ParallelWriter ECB;

        void Execute([ChunkIndexInQuery] int chunkIndex, Entity entity, ref BurgerDrop drop, ref LocalTransform transform)
        {
            // Fizyka
            ...
            transform.Scale = 5f * lifePercent;
