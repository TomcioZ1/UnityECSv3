...
[BurstCompile]
public partial struct IceDropSystem : ISystem
{
    [BurstCompile]
    ...
    [BurstCompile]
    public partial struct IceDropJob : IJobEntity
    {
        public float DeltaTime;
        public float3 Gravity;
        public EntityCommandBuffer.ParallelWriter ECB;

        void Execute([ChunkIndexInQuery] int chunkIndex, Entity entity, ref IceDrop drop, ref LocalTransform transform)
        {
            // Fizyka
